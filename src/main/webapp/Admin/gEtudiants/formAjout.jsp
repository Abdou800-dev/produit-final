...
<a class="" href="../espaceAdmin.jsp">Acceuil</a>
  ...
  <a href="../logoutAdmin">déconnexion</a>
	...
	<div class="col-sm-9">
<div class="content">
  <form action="../../ajEtudiant" method="POST" style="background-color:white;padding:5px ;margin:5px;border: 2px solid  #04AA6D;margin-left:250px;width:550px">
            ...
            <div class="form-outline mb-4">
                    ...
                    <input type="email" required  class="form-control" name="login"/>
				 ...
				 <div class="form-outline mb-4">
                  ...
                  <div class="form-outline mb-4">
                    ...
                    <option> <!-- somme java code to show up etab from the DB  --></option>
                    </select>
