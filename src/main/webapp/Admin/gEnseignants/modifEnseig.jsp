...
<a class="" href="../espaceAdmin.jsp">Acceuil</a>
  ...
  <a href="../gEtudiants/formAjEnseig.jsp">Ajouter</a>
  </div>
...
<div class="content">
  ...
  <form style="background-color:white;padding:5px ;margin:5px;border: 2px solid  #04AA6D;margin-left:250px;width:550px" action="../../miseEtudiant" method="POST">
  ...
  <input required  type="date" class="form-control" name="nom" value="${sessionScope.enseignant.getNom() }" >
  </div>
  <div class="form-outline mb-4">
