...
<body>
 <nav class="navbar navbar-expand-lg navbar-light bg-dark">
  ...
  <a class="navbar-brand" style="color:#fff;">Espace Enseignant  : ${sessionScope.enseignant.getNom()}</a>
...
<script>
 ...
 window.location.href = "http://localhost:8080/GestionAbsenceProduitFinal/Enseignant/warning.jsp";
</script>
...
<a class="active" href="espaceEtd.jsp">Acceuil</a>
  <a class="" data-toggle="collapse" data-target="#etudiant" aria-controlls="etudiant" href="#">Ajouter </a>
